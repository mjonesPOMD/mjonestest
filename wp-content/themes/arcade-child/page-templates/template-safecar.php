<?php
/**
 * Template Name: Landing - Safe Car
 *
 * Description: New Safe Car version of landing page.
 *
 * @since 1.0.0
 */
get_header(); ?>
...
<div class="elephant">
    ...
    <div class="hero">
        ...
        <div class="fx-centered--sm"><img class="absolute r-0 t-0 hero-car" src="<?php echo the_field('hero_image'); ?>" /></div>
    </div>
    ...
    <div class="features">
        ...
        <div class="feature-wrap">
            <img class="mb-20" src="<?php echo get_stylesheet_directory_uri(); ?>/library/images/reward_icon.png" />
    ...
    <div class="w-100 fx fx-center mt-68 mb-162 mt-0-sm mb-96-sm">
        <a href="https://quotes.elephant.com/#/postal-code" class="safe-car-button td-none">Start Saving With Safe Car</a>
    </div>
...
<div class="insurance-type-wrapper">
    ...
    <div class="insurance-type insurance-type--umbrella">
        <div class="fx fx-col insurance-type__content">
            <div class="insurance-type__header">Umbrella</div>
            <div class="insurance-type__description"><?php echo the_field('umbrella_insurance_copy'); ?></div>
            <a href="/umbrella-insurance" class="insurance-type__button" href="#">Learn More</a>
            <img class="insurance-type__image insurance-type__image--umbrella" src="<?php echo get_stylesheet_directory_uri(); ?>/library/images/umbrella.png" />
        </div>
    </div>
</div>
...
<div style="text-align:center;" class="benefit__title"><!--1-855-ELEPHANT--></div>
</div>
