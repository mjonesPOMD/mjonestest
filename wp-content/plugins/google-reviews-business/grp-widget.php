        ...
        if ($grp_google_api_key) {
            ...
            <ul style="line-height:20px">
                ...
                <li>
                    ...
                    <?php echo grp_i('Find the topic \'<b>If you are using the standard Google Places API Web Service</b>\' and click by \'<b>GET A KEY</b>\' button'); ?>
                </li>
                <li>
                    <span class="grw-step">3</span>
                    <?php echo grp_i('Agree term and click by \'<b>CREATE AND ENABLE API</b>\''); ?>
                </li>
                <li>
