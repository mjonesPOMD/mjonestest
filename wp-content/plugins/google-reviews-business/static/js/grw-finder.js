        ...
        WPacFastjs.each(res.places, function(place) {
            ...
            WPacFastjs.on(placeEl, 'click', function() {
                ...
                jQuery.get(grw_request_url('place_reviews'), {
                    ...
                    el.querySelector('.grw-place-photo').value = place.photo || place.icon;
...
function grw_renderPlace(place) {
    return '' +
        '<div class="media-left">' +
            '<img class="media-object" src="' + (place.photo || place.icon) + '" alt="' + place.name + '" style="width:32px;height:32px;">' +
        '</div>' +
